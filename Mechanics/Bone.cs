...
namespace TankProject
{
    class Bone : GameObject
    {
        ...
        //--------------------Constructors--------------------//
        internal Bone(Matrix boneMatrix, Vector3 objectPosition, Vector3 rotation, float scale) : base(boneMatrix.Translation * scale + objectPosition, rotation, Vector3.Zero, 0)
        {
